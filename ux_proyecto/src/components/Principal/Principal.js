                ...
                <div className="modal-body">
                       ...
                       <form action="/action_page.php">
                            <div className="form-group">
                                <input className="form-control" placeholder="Codigo de la clase"></input>
                            </div>
                        </form>
                </div>
                
                    <div className="modal-footer">
                        <button type="button" className="btn">Unirse</button>
                        <button type="button" className="btn" data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
        <div className="modal fade" id="mostrar_crear">
            <div className="modal-dialog">
                ...
                <div className="modal-body">
                       ...
                       <form action="/action_page.php">
                                <input placeholder="Nombre de la clase (obligatorio)" className="form-control"></input>
